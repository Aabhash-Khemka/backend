...
// you can check for each file individually like above but this is a  better method
  if(
 [fullName,email,username,password].some((field)=>field?.trim()==="")
  ...
  if(existedUser){
    throw new ApiError(409,"User with given email and username already exist")
  }
